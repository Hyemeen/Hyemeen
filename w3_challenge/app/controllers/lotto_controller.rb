...
class LottoController < ApplicationController
  ...
  def pick_and_check
    ...
    my_num = [*(1..45)].sample(6).sort
    # sample 메소드는 중복된 수를 뽑지 않으므로 uniq 써주지 않아도 됨.

    
    if (my_num & drw_numbers).length == 6
      my_result = "1등입니다! 축하합니다!\n"
    elsif (my_num & drw_numbers).length == 5 && (my_num & bonus_number).length == 1
      my_result = "2등입니다! 축하합니다!\n"
    elsif (my_num & drw_numbers).length == 5 && (my_num & bonus_number).length == 0
      my_result = "3등입니다! 축하합니다!\n"
    elsif (my_num & drw_numbers).length == 4
      my_result = "4등입니다 축하합니다!\n"
    elsif (my_num & drw_numbers).length == 3
      my_result = "5등입니다! 축하합니다!\n"
    else
      my_result = "다음을 기약해주세요.\n"
    end
